...
OUTPUT_DIR = "/home/user/tbrighton/Scripts/Training/3D_17n/trained_models_dynamit"
PLOT_DIR = "/home/user/tbrighton/Scripts/Training/3D_17n/plots_dynamit"
Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)
Path(PLOT_DIR).mkdir(parents=True, exist_ok=True)

# FILENAMES
BEST_MODEL_FILENAME = "dynamit_model_best.pth"
LAST_MODEL_FILENAME = "dynamit_model_last.pth"
METRICS_FILENAME = "dynamit_metrics.json"
...
def plot_per_tooth_metrics(metrics_dict, save_path):
    ...
    # Only calculate mean of non-zero (valid) scores for the line
...
def print_final_report(model, loader, device):
    ...
    valid_targets_flat, valid_preds_flat = [], [] # For Confusion Matrix
...
def main():
    ...
    print(f"\n[3/5] Training for {NUM_EPOCHS} epochs (DYNAMIT: 4096 pts)...")
    best_f1 = 0.0
