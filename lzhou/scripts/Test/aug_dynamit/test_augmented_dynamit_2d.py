...
MODEL_PATH = Path("/home/user/lzhou/week10/output/Train2D/aug_dynamit/dynamit_loss_full_dataset_best.pth")
OUTPUT_DIR = Path("/home/user/lzhou/week10/output/Test2D/aug_dynamit")
...
def export_results(ids, preds, targets, save_dir: Path, metrics):
    ...
    csv_path = save_dir / "test_predictions_dynamit.csv"
    results_df.to_csv(csv_path, index=False)
    json_path = save_dir / "test_metrics_dynamit.json"
