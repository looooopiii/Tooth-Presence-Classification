...
MODEL_PATH = Path("/home/user/lzhou/week11/output/Train2D/aug_normal_17out/bce_loss_full_dataset_best_17out.pth")
OUTPUT_DIR = Path("/home/user/lzhou/week11/output/Test2D/aug_normal_17out")
...
def print_metrics_summary(metrics):
    ...
    # remove raw data from metrics to save memory
    print("=" * 80)
