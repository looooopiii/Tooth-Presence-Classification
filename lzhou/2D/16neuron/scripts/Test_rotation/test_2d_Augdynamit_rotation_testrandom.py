...
DEFAULT_CHECKPOINT = "/home/user/lzhou/week16-17/output/Train_rotation/Augmented_testrandom_16plus1teeth_dynamit/augmented_dynamit_best_2d_16plus1teeth.pth"
DEFAULT_OUT_DIR = "/home/user/lzhou/week16-17/output/Test_rotation/augmented_16plus1teeth_dynamit_testrandom"
...
def parse_args():
    ...
    p.add_argument("--case_regex", type=str,
                   default=r"^(?P<case>.+?)_top_rx-?\d+_ry-?\d+_rz-?\d+\.png$",
