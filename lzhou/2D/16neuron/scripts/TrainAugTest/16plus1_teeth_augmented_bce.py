...
# Output directories
OUTPUT_DIR = "/home/user/lzhou/week15-17/output/Train2DAugTest/Augmented_16plus1teeth_bce"
PLOT_DIR = f"{OUTPUT_DIR}/plots"

# Model filenames
BEST_MODEL_FILENAME = "augmented_bce_best_2d_16plus1teeth.pth"
LAST_MODEL_FILENAME = "augmented_bce_last_2d_16plus1teeth.pth"
PLOT_FILENAME = "training_metrics_augmented_16plus1.png"
METRICS_FILENAME = "detailed_metrics_augmented_16plus1.json"
...
def create_tooth_missing_vector_16plus1_from_json(vertex_labels_set, jaw_type):
    ...
    Args:
        vertex_labels_set: Set of FDI labels present in scan
        jaw_type: "upper" or "lower"
    
    Returns:
        17-dimensional numpy array (16 teeth + 1 jaw)
    """
...
def create_tooth_missing_vector_16plus1_from_csv(csv_row, jaw_type):
    ...
    CSV has 32 teeth columns (FDI notation), we need to convert to 16 positions + jaw
    
    Args:
        csv_row: Pandas row with tooth columns (11, 12, ..., 48)
        jaw_type: "upper" or "lower"
    ...
    # Map from CSV 32-tooth format to 16 positions
    if jaw_type == "upper":
...
class AugmentedToothDataset16Plus1(Dataset):
    ...
    Reads CSV files and converts 32-tooth format to 16+1 format
    """
    def __init__(self, csv_paths, render_root, transform=None):
        ...
        for csv_path in csv_paths:
            ...
            for idx, row in df.iterrows():
                # Determine jaw type from filename
                ...
                # Convert CSV row to 16+1 format
...
def calculate_per_position_metrics(
    ...
    """Calculate per-position metrics (16 positions, separated by jaw)"""
    pred_np = pred.cpu().numpy()
...
def main():
    ...
    if len(full_dataset) == 0:
        ...
        print(f"   1. Augmented PNG images in: {RENDER_ROOT}, {RENDER_ROOT_TEST}")
