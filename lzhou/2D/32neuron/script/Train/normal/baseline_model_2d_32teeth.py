...
# Outputs
OUTPUT_DIR = "/home/user/lzhou/week15-32/output/Train2D/32teeth"
PLOT_DIR = "/home/user/lzhou/week15-32/output/Train2D/32teeth/plots"
Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)
Path(PLOT_DIR).mkdir(parents=True, exist_ok=True)

BEST_MODEL_FILENAME = "baseline_bce_best_2d_32teeth.pth"
LAST_MODEL_FILENAME = "baseline_bce_last_2d_32teeth.pth"
...
def calculate_per_tooth_metrics(pred, target, num_teeth=32):
    ...
    for tooth_idx in range(num_teeth):
        ...
        support = int(np.sum(tooth_target == 1))  # 1 = missing
    ...
    # Macro average (across all 32 teeth)
...
def plot_training_curves(history, save_dir, filename):
    ...
    fig.suptitle('ResNet18 2D Training - Micro Metrics', fontsize=16, fontweight='bold')
...
def main():
    ...
    print("\n" + "="*80)
    print(" "*10 + "2D TRAINING (32 Teeth - ResNet18 + BCE)")
    print("="*80)
