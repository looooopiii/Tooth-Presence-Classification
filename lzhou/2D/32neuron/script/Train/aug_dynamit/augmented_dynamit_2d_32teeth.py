...
OUTPUT_DIR = Path("/home/user/lzhou/week15-32/output/Train2D/aug_dynamit_32teeth")
PLOT_DIR = Path("/home/user/lzhou/week15-32/output/Train2D/aug_dynamit_32teeth/plots")
...
def plot_training_curves(history, save_dir):
    ...
    fig.suptitle('ResNet18 2D Training Metrics (Augmented Dataset - Dynamit Loss)', fontsize=16, fontweight='bold')
...
def main():
    ...
    print("✓ Using Dynamit Loss (Class-Balanced Weighting)")
