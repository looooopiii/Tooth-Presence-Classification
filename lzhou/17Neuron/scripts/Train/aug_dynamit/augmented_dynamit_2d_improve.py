...
OUTPUT_DIR = Path("/home/user/lzhou/week12/output/Train2D/aug_dynamit_17out")
PLOT_DIR = Path("/home/user/lzhou/week12/output/Train2D/aug_dynamit_17out/plots")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
PLOT_DIR.mkdir(parents=True, exist_ok=True)

BEST_MODEL_FILENAME = "dynamit_loss_full_dataset_best_17out.pth"
LAST_MODEL_FILENAME = "dynamit_loss_full_dataset_last_17out.pth"
PLOT_FILENAME = "dynamit_loss_full_dataset_metrics_17out.png"
METRICS_FILENAME = "dynamit_loss_full_dataset_detailed_metrics_17out.json"
...
# need to define FDI mappings for 32 to 17 conversion
# the old 32-FDI mapping (for reference)
...
# new 16-FDI to index mapping for upper and lower jaws
UPPER_FDI_TO_IDX16 = {
...
def resolve_png_path(rel_obj_path: str, primary_root: Path) -> Tuple[Optional[Path], Optional[str]]:
    # jaw can be 'upper' or 'lower' or None
...
# see below for train_epoch and validate_epoch modifications
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        # two outputs: teeth (16) and jaw (1)
