...
OUTPUT_DIR = Path("/home/user/lzhou/week12/output/Train2D/aug_normal_17out")
PLOT_DIR = Path("/home/user/lzhou/week12/output/Train2D/aug_normal_17out/plots")
...
def train_epoch(model, dataloader, criterion_teeth, criterion_jaw, optimizer, device):
    ...
    for images, labels in tqdm(dataloader, desc="Training", leave=False):
        ...
        # separately compute teeth and jaw losses
