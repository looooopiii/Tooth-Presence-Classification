...
MODEL_PATH = Path("/home/user/lzhou/week12/output/Train2D/aug_dynamit_17out_v2_strong_aug/dynamit_loss_full_dataset_best_17out_v2.pth")
OUTPUT_DIR = Path("/home/user/lzhou/week12/output/Test2D/aug_dynamit_17out_v2_strong_aug")
...
# calculate_per_tooth_metrics for 17-output model
def calculate_per_tooth_metrics(all_preds_17, all_targets_17):
    ...
    # use jaw label to determine mapping
...
# print_sample_predictions for 17-output model
def print_sample_predictions(ids, preds, targets, num_samples):
    ...
    for i in sample_indices:
        ...
        # Detailed comparison only if jaws match
        if true_jaw_str == pred_jaw_str:
...
def main():
    ...
    # calculate and print per-tooth metrics
