...
OUTPUT_DIR = Path("/home/user/lzhou/week4/multi_views7")
...
def create_tooth_material():
    ...
    # Principled BSDF for realistic tooth enamel appearance
    bsdf = nodes.new(type='ShaderNodeBsdfPrincipled')
    bsdf.inputs['Base Color'].default_value = (0.95, 0.92, 0.87, 1.0)
    bsdf.inputs['Subsurface'].default_value = 0.2
    bsdf.inputs['Subsurface Color'].default_value = (1.0, 0.95, 0.85, 1.0)
    bsdf.inputs['Roughness'].default_value = 0.25
    bsdf.inputs['Specular'].default_value = 0.5
    bsdf.inputs['Sheen'].default_value = 0.15
