...
OUTPUT_DIR = Path("/home/user/lzhou/week8/top_view_renders")
    ...
    for jaw in ['upper', 'lower']:
        ...
        for patient_folder in folder.iterdir(): 
            ...
            for view_name in camera_views.keys():
                out_path = OUTPUT_DIR / f"{jaw}jaw" / f"{patient_folder.name}_{jaw}_{view_name}.png"
            ...
            try:
                ...
                for view_name, camera_location in camera_views.items():
                    ...
                    out_path = subdir_path / f"{patient_folder.name}_{jaw}_{view_name}.png"
